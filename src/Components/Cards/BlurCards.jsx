...
const BlurCards = ({ heading, number, text, top, left, screenWidth }) => {
  ...
  return (
    <div
      ...
      className="h-fit sm:min-h-[250px] md:min-h-[300px] lg:min-h-[350px] xl:min-h-[400px] w-[200px] sm:w-[250px] md:w-[300px] lg:w-[375px] xl:w-[440px] p-6 grid auto-rows-min item content-evenly border border-[#1C191A] text-white leading-none rounded-3xl absolute z-[2]"
    >
