  ...
  return (
    <div className="h-fit w-[95%] mx-auto py-8 sm:py-10 md:py-14 grid grid-cols-2 grid-rows-2 md:grid-rows-1 md:grid-cols-3 justify-center items-center gap-[12px_0px] md-gap-[0_0] border-t-2 border-[#7a7a76] text-white">
      ...
      <div className="flex flex-col justify-center items-center leading-none">
        <p className="text-lg sm:text-2xl lg:text-3xl tracking-wider">{role}</p>
        <div>
          <span>Remote</span>
          <span>Full-time</span>
        </div>
      </div>
      <span className="my-2 md:my-0 col-span-2 md:col-span-1 justify-self-center md:justify-self-end">
