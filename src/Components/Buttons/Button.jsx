...
const Button = ({ text = "Live Website", bgColor = "white" }) => {
  return (
    <div
      ...
      className={`px-3.5 sm:px-4 lg:px-5 xl:px-6 py-[5px] xl:py-1.5 h-fit w-fit rounded-full flex justify-center gap-1 items-center`}
    >
      <p
        className="w-fit text-[10px] sm:text-[11px] lg:text-xs xl:text-sm tracking-wide font-[Satoshi-Regular]"
      >
        {text}
      </p>
